...
class Systematics:
    ...
    CENT_CV_CUT = [0.7, 0.7, 0.7, 0.7, 0.7, 0.7]
    MIN_CV_CUT = [0.3, 0.33999999999999997, 0.3, 0.3, 0.3, 0.3]
    MAX_CV_CUT = [0.82, 0.8099999999999999, 0.82, 0.83, 0.83, 0.89]
    #CENT_CV_CUT = None
    #MIN_CV_CUT = None
    #MAX_CV_CUT = None
